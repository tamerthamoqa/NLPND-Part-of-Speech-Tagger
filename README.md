# NLPND-Part-of-Speech-Tagger
This is the first required project in the Natural Language Processing Nanodegree Udacity program. The starter code is from this [repository](https://github.com/udacity/Project-Part-of-Speech-Tagging) by Udacity.
